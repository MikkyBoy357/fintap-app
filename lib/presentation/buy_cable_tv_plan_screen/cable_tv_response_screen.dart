...
class CableTVResponseScreen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final screenSize = MediaQuery.of(context).size;
    final ResponseData data = Get.arguments;
    return SafeArea(
      top: false,
      child: Scaffold(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                "You have successfully subscribed ${data.extra!.uniqueElement} with ${data.extra!.unitPrice}",
                                maxLines: null,
