...
class CustomCableTVDropDown extends StatelessWidget {
  ...
  Function(TVData)? onChanged;

  FormFieldValidator<TVData>? validator;
  ...
  _buildDropDownWidget() {
    return Container(
      ...
      margin: margin,
      child: DropdownButtonFormField<TVData>(
        isExpanded: true,
        focusNode: focusNode,
        value: value,
        icon: icon,
        ...
        items: items?.map((TVData data) {
          return DropdownMenuItem<TVData>(
            value: data,
            child: Row(
              children: [
                CachedNetworkImage(
