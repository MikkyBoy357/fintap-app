...
class CustomBankDropDown extends StatelessWidget {
  ...
  List<BanksData>? items;

  Function(BanksData)? onChanged;

  FormFieldValidator<BanksData>? validator;
  ...
  _buildDropDownWidget() {
    return Container(
      ...
      margin: margin,
      child: DropdownButtonFormField<BanksData>(
        isExpanded: true,
        focusNode: focusNode,
        value: value,
        icon: icon,
        ...
        items: items?.map((BanksData data) {
