...
class DataResponseModel {
  ...
  DataResponseModel({this.status, this.message, this.data});

  DataResponseModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
    message = json["message"];
    data = json["data"] == null ? null : ResData.fromJson(json["data"]);
  }
...
class ResData {
  ...
  ResData({this.userid, this.description, this.amount, this.reference, this.type, this.service, this.status, this.prevBalance, this.balanceAfter, this.extra});
