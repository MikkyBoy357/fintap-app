...
class CustomAvailableInvestmentDropDown extends StatelessWidget {
  ...
  List<InvestmentData>? items;

  Function(InvestmentData)? onChanged;

  FormFieldValidator<InvestmentData>? validator;
  ...
  _buildDropDownWidget() {
    return Container(
      ...
      margin: margin,
      child: DropdownButtonFormField<InvestmentData>(
        isExpanded: true,
        focusNode: focusNode,
        value: value,
        icon: icon,
        ...
        items: items?.map((InvestmentData data) {
          return DropdownMenuItem<InvestmentData>(
            value: data,
            child: Row(
              children: [
                CachedNetworkImage(
