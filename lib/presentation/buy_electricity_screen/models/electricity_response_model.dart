class BuyElectricityResponseModel {
  bool? status;
  String? message;
  ResponseData? data;

  BuyElectricityResponseModel({this.status, this.message, this.data});

  BuyElectricityResponseModel.fromJson(Map<String, dynamic> json) {
    status = json["status"];
...
class Extra {
  ...
  Map<String, dynamic> toJson() {
    ...
    _data["purchased_code"] = purchasedCode;
